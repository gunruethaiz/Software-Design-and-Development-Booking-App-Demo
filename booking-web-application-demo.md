...
#### บันทึกผลการรัน
![รูปผลการรันหน้า front-end![alt text](image-4.png)(./image-path/image.png)
...
#### axios คืออะไร ?
```html
  Axios เป็นไลบรารี JavaScript ที่ใช้สำหรับทำ HTTP requests ซึ่งช่วยให้การสื่อสารกับ API ง่ายและสะดวกมากขึ้น โดย axios รองรับการทำงานทั้งการดึงข้อมูล (GET) และการส่งข้อมูล (POST) รวมถึงการอัปเดตและลบข้อมูล (PUT, DELETE) ได้อย่างมีประสิทธิภาพ
```
...
#### บันทึกรูปผลการรัน
![ผลการรัน](./image path/image.png)![alt text](image-5.png)
...
#### บันทึกผลการรัน
```html
บันทึกสาเหตุที่ทำให้เกิด error 
เส้นทางไฟล์ไม่ถูกต้อง: ตรวจสอบว่าเส้นทางที่ใช้ถูกต้อง
ชื่อไฟล์ไม่ตรงกัน: ให้แน่ใจว่าชื่อไฟล์ตรงตามต้นฉบับ
การส่งออกไม่ถูกต้อง: ต้องแน่ใจว่าคอมโพเนนต์ถูกส่งออกอย่างถูกต้อง
นามสกุลไฟล์ไม่ตรง: ตรวจสอบว่านามสกุลไฟล์ตรงกับที่ระบุ
การตั้งค่าพื้นฐานผิด: อาจมีปัญหาจากการตั้งค่าของWebpack หรือ tsconfig
แคชเบราว์เซอร์: ล้างแคชและรีสตาร์ทเซิร์ฟเวอร์
```
...
#### บันทึกผลการทดลอง
![รูปหน้าจองห้องพัก ที่แสดงข้อมูลสรุปการจอง]![alt text](image-6.png) ![alt text](image-7.png)
...
### บันทึกผลการทดลอง 
![รูปรายการจองห้องพัก]![alt text](image-8.png)
...
### บันทึกผลการทดลอง
![ผลการแก้ไขข้อมูลการจอง]![alt text](image-9.png)
...
3) บันทึกผลการทดลอง เมื่อกดปุ่ม "สำหรับผู้ดูแลระบบ"
   ### บันทึกผลการทดลอง
![ผลการแก้ไขข้อมูลการจอง]![alt text](image-10.png)
